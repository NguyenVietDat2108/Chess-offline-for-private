    ...
    return (function(Stockfish) {
        ...
        function Ta(a) {
            for (; 0 < a.length; ) {
                ...
                if ("function" == typeof b)
                    ...
                    var c = b.sc;
                    "number" === typeof c ? void 0 === b.nb ? dynCall_v.call(null, c) : dynCall_vi.apply(null, [c, b.nb]) : c(void 0 === b.nb ? null : b.nb)
                }
            }
        }
        function db(a, b) {
            ...
            md: function(a, b) {
                a.onmessage = function(c) {
                    ...
                    if (d.targetThread && d.targetThread != jb()) {
                        ...
                        "cancelDone" === f ? B.Cb(a) : "objectTransfer" !== f && ("setimmediate" === c.data.target ? a.postMessage(c.data) : N("worker sent an unknown command " + f));
                    B.Yc = void 0
                }
                ;
        ...
        var Ib = {
            ...
            write: function(a, b, c, d) {
                if (!a.tty || !a.tty.ib.Zb)
                    throw new P.Y(60);
                try {
                    for (var f = 0; f < d; f++)
                        a.tty.ib.Zb(a.tty, b[c + f])
                } catch (g) {
                    throw new P.Y(29);
                }
        ...
        var W = {
            ...
            createNode: function(a, b, c, d) {
                ...
                P.Ea(c.mode) ? (c.ya = W.Pa.dir.node,
                c.Aa = W.Pa.dir.stream,
                c.za = {}) : P.isFile(c.mode) ? (c.ya = W.Pa.file.node,
                c.Aa = W.Pa.file.stream,
                c.Ca = 0,
                c.za = null) : P.fb(c.mode) ? (c.ya = W.Pa.link.node,
                c.Aa = W.Pa.link.stream) : P.xb(c.mode) && (c.ya = W.Pa.jc.node,
                c.Aa = W.Pa.jc.stream);
            ...
            ya: {
                Ma: function(a) {
                    ...
                    b.gid = 0;
                    b.rdev = a.rdev;
                    P.Ea(a.mode) ? b.size = 4096 : P.isFile(a.mode) ? b.size = a.Ca : P.fb(a.mode) ? b.size = a.link.length : b.size = 0;
                ...
                readdir: function(a) {
                    var b = [".", ".."], c;
                    for (c in a.za)
                        a.za.hasOwnProperty(c) && b.push(c);
                    return b
                },
            ...
            Aa: {
                ...
                write: function(a, b, c, d, f, g) {
                    ...
                    if (b.subarray && (!a.za || a.za.subarray)) {
                        if (g)
                            return a.za = b.subarray(c, c + d),
                            a.Ca = d;
                        if (0 === a.Ca && 0 === f)
                            return a.za = b.slice(c, c + d),
                            a.Ca = d;
                        if (f + d <= a.Ca)
                            return a.za.set(b.subarray(c, c + d), f),
                            d
                    }
                    W.pc(a, f + d);
                    if (a.za.subarray && b.subarray)
                        a.za.set(b.subarray(c, c + d), f);
                    else
                        for (g = 0; g < d; g++)
                            a.za[f + g] = b[c + g];
        ...
        var P = {
            ...
            qd: function(a, b) {
                return a ? P.fb(a.mode) ? 32 : P.Ea(a.mode) && ("r" !== P.qc(b) || b & 512) ? 31 : P.cb(a, P.qc(b)) : 44
            },
            Ic: 4096,
            td: function(a, b) {
                b = b || P.Ic;
            ...
            Ec: function(a, b) {
                ...
                a = !1);
                P.Db++;
                1 < P.Db && N("warning: " + P.Db + " FS.syncfs operations in flight at once, probably just doing extra work");
            ...
            write: function(a, b, c, d, f, g) {
                ...
                k || (a.position += b);
                try {
                    if (a.path && P.Fa.onWriteToFile)
                        P.Fa.onWriteToFile(a.path)
                } catch (p) {
            ...
            mb: function(a, b, c) {
                ...
                if (0 === (a.flags & 2097155))
                    throw new P.Y(8);
                if (!P.isFile(a.node.mode) && !P.Ea(a.node.mode))
                    throw new P.Y(43);
                if (!a.Aa.mb)
                    throw new P.Y(138);
                a.Aa.mb(a, b, c)
            ...
            Sd: function(a, b, c, d, f) {
                ...
                k.za ? p.za = k.za : k.url && (p.za = null,
                p.url = k.url);
        ...
        function Rb(a, b) {
            ...
            try {
                ...
                if (f && f.node && Ab(a) !== Ab(P.Wa(f.node)))
                    return -54;
                throw f;
            }
            w()[b >> 2] = d.dev;
        ...
        function Ub(a, b, c) {
            ...
            try {
                ...
                return "undefined" !== typeof P && g instanceof P.Y || M(g),
                -g.Ga
            }
        }
        function Wb(a, b) {
            ...
            try {
                ...
                return "undefined" !== typeof P && d instanceof P.Y || M(d),
                -d.Ga
            }
        }
        function Xb(a, b, c) {
        ...
        function Yb(a, b, c, d, f, g) {
            ...
            try {
                ...
                return "undefined" !== typeof P && z instanceof P.Y || M(z),
                -z.Ga
            }
        }
        function Zb(a, b) {
            ...
            try {
                ...
                return "undefined" !== typeof P && t instanceof P.Y || M(t),
                -t.Ga
            }
        }
        function $b(a, b, c) {
        ...
        function ac(a, b) {
            ...
            try {
                ...
                return "undefined" !== typeof P && c instanceof P.Y || M(c),
                -c.Ga
            }
        }
        function bc() {
        ...
        function jc(a, b, c) {
            ...
            if (d.Ac || !d.Rd)
                d.Ac && (d = d.Ac),
                a = !1,
                d.vb && d.vb.ub && (a = d.vb.ub.getParameter(2978),
        ...
        function Cc(a, b) {
            ...
            try {
                ...
                return "undefined" !== typeof P && f instanceof P.Y || M(f),
                f.Ga
            }
        }
        function Dc(a, b, c, d) {
            ...
            try {
                ...
                return "undefined" !== typeof P && r instanceof P.Y || M(r),
                r.Ga
            }
        }
        function Ec(a, b, c, d, f) {
            ...
            try {
                ...
                return "undefined" !== typeof P && k instanceof P.Y || M(k),
                k.Ga
            }
        }
        function Fc(a, b, c, d) {
        ...
        function Lc(a, b, c, d) {
            ...
            n = {
                ...
                "%V": function(l) {
                    ...
                    return 0 > k(I, y) ? "53" : 0 >= k(u, I) ? "01" : g(Math.ceil((y.getFullYear() < l.Ia + 1900 ? l.Gb + 32 - y.getDate() : l.Gb + 1 - y.getDate()) / 7), 2)
                },
                "%w": function(l) {
                    return l.Fb
                },
        ...
        var fd = {
            ...
            P: function(a, b, c, d) {
                ...
                return G ? (c.Qd = "spawnThread",
                postMessage(c, f),
                0) : nb(c)
            },
            N: function(a) {
                return a ? w()[a + 12 >> 2] !== a ? (N("pthread_detach attempted on thread " + a + ", which does not point to a valid thread, or does not exist anymore!"),
                71) : Atomics.compareExchange(x(), a + 64 >> 2, 0, 2) ? 28 : 0 : (N("pthread_detach attempted on a null thread pointer!"),
                71)
            },
            M: function(a) {
                G ? B.Fc(a) : (B.Cc(),
        ...
        A._emscripten_current_thread_process_queued_calls = function() {
            return (A._emscripten_current_thread_process_queued_calls = A.asm.Z).apply(null, arguments)
        }
        ;
        var hb = A._emscripten_register_main_browser_thread_id = function() {
            return (hb = A._emscripten_register_main_browser_thread_id = A.asm._).apply(null, arguments)
        }
          , xb = A._emscripten_main_browser_thread_id = function() {
            return (xb = A._emscripten_main_browser_thread_id = A.asm.$).apply(null, arguments)
        }
          , ed = A._emscripten_sync_run_in_main_thread_4 = function() {
            return (ed = A._emscripten_sync_run_in_main_thread_4 = A.asm.aa).apply(null, arguments)
        }
          , mb = A._emscripten_main_thread_process_queued_calls = function() {
            return (mb = A._emscripten_main_thread_process_queued_calls = A.asm.ba).apply(null, arguments)
        }
          , fc = A._emscripten_run_in_main_runtime_thread_js = function() {
            return (fc = A._emscripten_run_in_main_runtime_thread_js = A.asm.ca).apply(null, arguments)
        }
          , kc = A.__emscripten_call_on_thread = function() {
            return (kc = A.__emscripten_call_on_thread = A.asm.da).apply(null, arguments)
        }
        ;
        ...
        var yb = A._pthread_testcancel = function() {
          ...
          , tb = A._emscripten_get_global_libc = function() {
            return (tb = A._emscripten_get_global_libc = A.asm.ka).apply(null, arguments)
        }
          , ib = A.___pthread_tsd_run_dtors = function() {
            return (ib = A.___pthread_tsd_run_dtors = A.asm.la).apply(null, arguments)
        }
